...
{
    const void* content; // Data container
...
CF_EXPORT LSQNodeRef  NewLSQNode         (const void *content, LSQBaseVtableRef); // Constructor
...
CF_EXPORT const void* LSQNodeGetContent  (LSQNodeRef);                            // Get node content
